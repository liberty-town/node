...
func NewTcpServer() error {
	...
	if _, err = os.Stat(certPath); err == nil {
		...
		if (arguments.Arguments["--tcp-server-address"] == nil || arguments.Arguments["--tcp-server-address"] == "") && arguments.Arguments["--tcp-server-url"] == nil {
	...
	if tlsConfig != nil {
		...
		gui.GUI.Warning("No TLS Certificate", address, port)
	}
